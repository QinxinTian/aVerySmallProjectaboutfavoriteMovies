...
def main():
    ...
    silenthill = media.Movie("Silent Hill",
                          "A woman, rose, goes in search for her adopted daughter within the confines of a strange,"
                          "desolated town Called Silent Hill",
                        "https://vignette.wikia.nocookie.net/silent/images/3/3b/Walkinsh.jpg/revision/latest?cb=20141128110555",
                        "https://www.youtube.com/watch?v=Y2M8iYL8suw",
                        "December, 8, 2015")

    losthighway = media.Movie("Lost Highway",
                          "After a bizarre encounter at a party, a jazz saxophonist is framed for the murder of his wife"
                          " and sent to prison, where he inexplicably morphs into a young mechanic and begins leading"
                          "a new life.",
                          "https://img.moviepostershop.com/lost-highway-movie-poster-1997-1010730374.jpg",
    ...
    paloalto = media.Movie("Palo Alto",
                           ...
                           "https://i.pinimg.com/736x/f3/c8/0e/f3c80ef6056bad88529fd9d9add37cc0--gia-coppola-emma-roberts.jpg",
    ...
    themlaandlouise = media.Movie("Thelma and Louise",
                         ...
                         "https://cdn.shopify.com/s/files/1/0630/8509/products/pst0502TandL_large.jpg?v=1470942122",
    ...
    lacaraoculta = media.Movie("La Cara Oculta",
                          ...
                          "https://resizing.flixster.com/0quba9IOsuMuvKgAoZse0Gz7CLk=/206x305/v1.bTsxMTE2NTUyNztqOzE3ODU5OzEyMDA7NDUwOzYwMA",
                          "https://www.youtube.com/watch?v=hWq_1Pj0QDM",
                          "September, 16, 2011")

    # Store the Movie objects in a list.
    movies = [silenthill, losthighway, paloalto, themlaandlouise, mrandmrssmith, lacaraoculta]
